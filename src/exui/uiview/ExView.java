...
public abstract class ExView extends ExO4Binding implements I_View {
	...
	@Override
	public boolean adjust_IsAutoWidth() {
		return this.width_auto;
	}

	@Override
	public boolean adjust_IsAutoHeight() {
		return this.height_auto;
	}
	...
	public void size_SetVisibleSize(I_Size vSize) {
		if (vSize.getWidth() > this.basicSize.getWidth() || vSize.getHeight() > this.basicSize.getHeight()) {
	...
	@Override
	public void view_setUIBuilder(I_ViewBuilder<I_Object4BindingCommon> builder) {
	 ...
	 */
	@Override
	public abstract void __operate_paintItSelf(I_GraphicsPort port);
	...
	public Area clip_getClipShape() {
		Area thisShape = new Area(
				new Rectangle2D.Double(0, 0, this.visibleSize.getWidth(), this.visibleSize.getHeight()));
